namespace UITestDirect2.Core.Helpers
{
    ...
    public struct DataStep1
    {
        ...
        private string txtYearMoved;
        private string txtMiddleInitial;
        private string txtMothersName;
        #endregion
        ...
        #region FCA
        public string TxtStreetName { get => txtStreetName; set => txtStreetName = value; }
        public string TxtState { get => txtState; set => txtState = value; }
        public string TxtYearMoved { get => txtYearMoved; set => txtYearMoved = value; }
        public string TxtMiddleInitial { get => txtMiddleInitial; set => txtMiddleInitial = value; }
        public string TxtMothersName { get => txtMothersName; set => txtMothersName = value; }
        #endregion
    ...
    public struct DataStep2
    {
        private string cmbEmployment;
            #region FCA and Cysec
            private string cmbEmploymentPosition;
            #endregion
        ...
        #region FCA
        private string cmbCountryOfOrigin;
        #endregion
        ...
        #region FCA
        private string cmbRiskQuestion1;
        #endregion
        ...
        public string CmbEmployment { get => cmbEmployment; set => cmbEmployment = value; }
            #region FCA and Cysec
            public string CmbEmploymentPosition { get => cmbEmploymentPosition; set => cmbEmploymentPosition = value; }
            #endregion
        ...
        #region FCA Cysec
        public string CmbCountryOfOrigin { get => cmbCountryOfOrigin; set => cmbCountryOfOrigin = value; }
        #endregion
        ...
        #region FCA
        public string CmbRiskQuestion1 { get => cmbRiskQuestion1; set => cmbRiskQuestion1 = value; }
        #endregion
    ...
    public struct DataStep3
    {
        ...
        #region FCA Cysec
        private bool btnProClientInterestedYes;
        private bool btnProClientInterestedNo;
        #endregion
        ...
        #region FCA Cysec
        public bool BtnProClientInterestedYes { get => btnProClientInterestedYes; set => btnProClientInterestedYes = value; }
        public bool BtnProClientInterestedNo { get => btnProClientInterestedNo; set => btnProClientInterestedNo = value; }
        #endregion
