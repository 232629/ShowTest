...
namespace UITestDirect2.Core.Infrastructure
{
    public static class ScreenShots
    {
        ...
        public static void SaveScreenshotAllPage(IWebDriver driver, string fileName, int timeout = 0)
        {
            ...
            fileName = (fileName.Length > 150)?fileName.Remove(150) : fileName;
            GetScreenshotAllPage(driver, timeout).Save(folderName + @"\Screenshots\" + fileName.Replace("\"", "") + "_" + DateTime.Now.ToLongTimeString().Replace(":", ".") + ".jpg", ImageFormat.Jpeg);
        }
