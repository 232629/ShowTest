...
namespace UITestDirect2
{
    ...
    public partial class UITestDirect2Mena
    {
        ...
        public void ClosedAccount(string login, string header, string msg, string lng)
        {
            ...
            LoginHelper.Login(webDriver, lng, login, "Password1");

            PageClosedAccount pageClosedAccount = new PageClosedAccount(webDriver, lng);
            ...
            PageAfterLogout pageAfterLogout = new PageAfterLogout(webDriver, lng);
