...
namespace UITestDirect2
{
    ...
    public partial class UITestDirect2Mena
    {
        ...
        /// 1 step:
        /// 2 step:
        /// Are you a US citizen or a US resident for tax purposes? > Yes
        ...
        [TestCase("en")]
        [Description(
            "1 step: DFSA, Country > UnitedArabEmirates \n\r2 step: \n\r3 step: Are you a US citizen or a US resident for tax purposes? > Yes, Do you have trading experience? > No \n\r4 step: Verify your profile now? > No")]
        public void RegistrationNewUser_UAE_Yes_No_No(string lng)
        {
            #region Test Data
            ...
            dataStep2.UsCitizen = new DataStep2.DataUsCitizen(btnUScitizen: true)
            {
                TxtUsTaxCode = "123456789"
            };
            //Trading Experience
