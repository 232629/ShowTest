...
namespace UITestDirect2
{
    ...
    public partial class UITestDirect2Mena
    {
        ...
        [TestCase("en")]
        [Description(
            "1 step: DFSA, Country > UnitedArabEmirates \n\r2 step: \n\r3 step: Are you a US citizen or a US resident for tax purposes? > No, Do you have trading experience? > Yes \n\r4 step: Verify your profile now? > No")]
        public void RegistrationNewUser_UAE_No_Yes_No(string lng)
        {
            #region Test Data
            ...
            dataStep2.CmbTradingExperience = "Yes, I have traded on a real account";
                ...
                dataStep2.CmbHowManyTimesYouTraded = "More than 10 per quarter";
