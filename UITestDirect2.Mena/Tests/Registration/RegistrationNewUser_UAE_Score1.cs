...
namespace UITestDirect2
{
    ...
    public partial class UITestDirect2Mena
    {
        ...
        /// Appropriateness Status = Passed. Score = 1
        /// 0 step: 
        /// DFSA
        ...
        public void RegistrationNewUser_UAE_Score1(string lng)
        {
            #region Test Data
            ...
            Assert.AreEqual(@"I am aware that trading leveraged products might result in losing all invested capital. I also understand that based on my experience and the responses I have provided in the appropriateness test, such products may not be appropriate for me, yet wish to be reassessed for opening a real trading account.", pageRregisterStep3.LblSubmissionRiskAwareness.Text);
