...
namespace UITestDirect2
{
    ...
    public partial class UITestDirect2Mena
    {
        ...
        public void RegistrationNewUser_UAE_NotProfessional(string lng)
        {
            #region Test Data
            ...
            //Estimated Net Worth < 1 000 000 (can't choose a professional client)
            dataStep2.CmbEstimatedNetWorth = "$500,000 - $1,000,000";
            ...
            dataStep3.CmbAccountType = "cTrader";
